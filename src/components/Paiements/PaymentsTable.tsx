    ...
    <Card>
      <div className="overflow-x-auto">
        <Table>
          <TableHeader>
            <TableRow>
              <TableHead>Etude</TableHead>
              <TableHead>Volontaire</TableHead>
              <TableHead>Groupe</TableHead>
              <TableHead>Numero sujet</TableHead>
              ...
              rows.map((p, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell>{p.numsujet || 'Non défini'}</TableCell>
                    <TableCell>
                      <span className={`font-semibold ${estAnnule ? 'line-through text-muted-foreground' : ''}`}>
                        {currency(p.iv)}
                      </span>
                      {estAnnule && (
                        <div className="text-xs text-destructive">(Exclu des calculs)</div>
                      )}
                    </TableCell>
                    <TableCell>
                    ...
                    <TableCell>
                      ...
                      >
                        <SelectTrigger 
                          className="w-[140px]"
                          disabled={estAnnule}
                          title={estAnnule ? `Impossible de modifier le paiement d'un volontaire annulé` : ''}
                        >
                          <SelectValue />
                        </SelectTrigger>
                        <SelectContent>
