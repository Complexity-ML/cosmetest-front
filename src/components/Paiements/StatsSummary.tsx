  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
      <Card className="bg-blue-50 border-blue-100 p-4">
        <h3 className="text-sm font-medium text-blue-800">Total paiements actifs</h3>
        <p className="text-2xl font-bold text-blue-900">{s.total || 0}</p>
        {(s.annulesCount ?? 0) > 0 && (
          <p className="text-xs text-blue-700">{s.annulesCount} annules exclus</p>
        )}
      </Card>

      <Card className="bg-green-50 border-green-100 p-4">
        <h3 className="text-sm font-medium text-green-800">Payes</h3>
      ...
      <Card className="bg-red-50 border-red-100 p-4">
        <h3 className="text-sm font-medium text-red-800">Non payes</h3>
      ...
      <Card className="bg-gray-50 border-gray-100 p-4">
        <h3 className="text-sm font-medium text-gray-800">Annules</h3>
