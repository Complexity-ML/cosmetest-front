  ...
  <Card>
    ...
    <CardContent className="space-y-6">
      <div className="space-y-2">
        <p className="text-sm font-medium text-brand-cyan">{t('volunteers.overallEvaluation')}</p>
      ...
      <div className="space-y-4">
        <p className="text-sm font-medium text-brand-cyan">{t('volunteers.specificAreasEvaluation')}</p>
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          {SPECIFIC_EVALUATIONS.map(({ field, labelKey }) => (
